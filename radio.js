...
function newRadio() {
    ...
    radio.className = "question isRadio";
    ...
    function radioChange() {
        ...
        for (i = 0; i < add.length; i++) {
            add[i].onclick = function () {
                if (add.length < 10) {
                    this.parentNode.parentNode.appendChild(newrad());
                    radioChange();
                } else {
                    alert("选项不能再多了哦！");
                }
